...
use eZ\Publish\Core\FieldType\XmlText\Converter\ExpandingSectionParagraph;
    ...
    protected function getConverter()
    {
        if ($this->converter === null) {
            $this->converter = new Aggregate(
                array(
                    new ToRichTextPreNormalize([new ExpandingToRichText(), new ExpandingSectionParagraph(), new EmbedLinking()]),
                    new Xslt(
